package fun.junjie.ftgo.orderservice.service;
...
import fun.junjie.ftgo.orderservice.domain.OrderService;
import fun.junjie.ftgo.orderservice.sagaparticipants.BeginReviseOrderReply;
import fun.junjie.ftgo.orderservice.sagaparticipants.commands.*;
    ...
    public Message beginReviseOrder(CommandMessage<BeginReviseOrderCommand> cm) {
        ...
        try {
            return orderService.beginReviseOrder(orderId, revision)
                    .map(result ->
                            withSuccess(new BeginReviseOrderReply(result.getChange().getNewOrderTotal()))
                    )
